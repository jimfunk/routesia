...
from routesia.dhcp.dhcpserverconfig import DHCP4Config
...
from routesia.netlink.netlinkevents import InterfaceAddEvent, InterfaceRemoveEvent
from routesia.schema.v2 import dhcp_server_pb2
